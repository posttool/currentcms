var form_fields = {
  ...
  boolean_field: function (options) {
    var self = this;
    mixin_emitter(self);
    var $el = mixin_basic_component(self, 'field boolean');
  ...
  number_field: function (options) {
    var self = this;
    mixin_emitter(self);
    var $el = mixin_basic_component(self, 'field number');
  ...
  input_field: function (options) {
    var self = this;
    mixin_emitter(self);
    var $el = mixin_basic_component(self, 'field string');
  ...
  code_field: function (options) {
    ...
    // fires above at setValue, which is very weird to me!!! can i get something that just fires when user makes change?
  ...
  rich_text_field: function (options) {
    var self = this;
    mixin_emitter(self);
    var $el = mixin_basic_component(self, 'field rich-text');
...
//    });
  ...
  datetime_field: function (options) {
    var self = this;
    mixin_emitter(self);
    var $el = mixin_basic_component(self, 'field date');
    ...
    function update_ui() {
      $c.val(_d.format('YYYY/MM/DD HH:mm'));
    }

    $c.datetimepicker({ onChangeDateTime: function(curdt){
      _d = moment(curdt);
      self.emit('change');
    }});
    $c.keyup(function () {
  ...
  upload_field: function (options) {
    var self = this;
    mixin_emitter(self);
    var $el = mixin_basic_component(self, 'field resource');
  ...
  model_field: function (options) {
    var self = this;
    mixin_emitter(self);
    var $el = mixin_basic_component(self, 'model '+options.type);
...
//        bg_w_grad($el, thumb);
  ...
  resource_meta_field: function(options) {
    var self = this;
    mixin_emitter(self);
    var $el = mixin_basic_component(self, 'resource-path');
  ...
  json_field: function(options) {
    var self = this;
    mixin_emitter(self);
    var $el = mixin_basic_component(self, 'json');
  ...
  choose_create_field: function (options) {
    var self = this;
    mixin_emitter(self);
    var $el = mixin_basic_component(self, 'field choose_create');
